...
import { DataManageService, LoadingService, GetJsonService, InterfaceParamModelService, UpdataSubjectService } from '../../shared/service';
import { Router } from '@angular/router';
declare const $: any, lenovoPublic;

@Component({
    selector: 'app-prediction-history',
    templateUrl: './prediction_history_details.component.html',
    styleUrls: ['./prediction_history_details.component.scss']
})

export class PredictionHistoryDetailsComponent implements OnInit, AfterViewInit {
